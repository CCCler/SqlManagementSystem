...
KEYWORDS = frozenset("CREATE TABLE INT VARCHAR INSERT INTO VALUES SELECT FROM WHERE DELETE DROP BEGIN COMMIT ROLLBACK TRUE FALSE NOT AND OR EXPLAIN DISTINCT LIMIT ORDER BY ASC DESC OFFSET".split())
